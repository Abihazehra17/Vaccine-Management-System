...
if ($result) {
    $children_count = (int) mysqli_fetch_assoc($result)['total'];
}
...
if ($result) {
    $parents_count = (int) mysqli_fetch_assoc($result)['total'];
}
...
if ($result) {
    $hospitals_count = (int) mysqli_fetch_assoc($result)['total'];
}
...
$result = mysqli_query(
    $connection,
    "SELECT COUNT(*) AS total FROM vaccines"
);

$vaccines_count = 0;

if ($result) {
    $vaccines_count = (int) mysqli_fetch_assoc($result)['total'];
}
...
if ($result) {
    $pending_count = (int) mysqli_fetch_assoc($result)['total'];
}
...
if ($result) {
    $vaccinated_count = (int) mysqli_fetch_assoc($result)['total'];
}
...
if ($result) {
    $total_appointments = (int) mysqli_fetch_assoc($result)['total'];
}
        ...
        <div class="d-flex flex-column flex-xl-row justify-content-between align-items-start align-items-xl-center mb-4 gap-3">
            ...
            <div>
                ...
                <p class="mb-0 small"
                   style="color: var(--vax-text-muted);">
                    ...
                    Vaccination monitoring, scheduled child appointments,
                    hospital directory & reports
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <!-- <a href="appointments.php"
                   class="btn btn-sm rounded-pill text-dark shadow-sm d-flex align-items-center gap-2"
                   style="background-color: #f59e0b;
                    ...
                    <span>
                        Pending Doses ( echo $pending_count; ?> )
                    </span>
                ...
                <a href="appointments.php"
                   class="btn btn-sm rounded-pill text-white shadow-sm d-flex align-items-center gap-2"
            ...
            <div class="alert-banner-left">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        ...
                        awaiting vaccination status update
                        in your clinic queue.
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="quick-nav-card">
                    ...
                    <div class="quick-nav-subtitle">

                        Upcoming vaccination dates of all children
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="quick-nav-card">
                    ...
                    <div class="quick-nav-subtitle">
                        ...
                        View catalog & toggle availability
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="quick-nav-card">
                    ...
                    <div class="quick-nav-subtitle">
                        ...
                        View facility license & clinic location
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="quick-nav-card">
                    ...
                    <div class="quick-nav-subtitle">
                        ...
                        Filter date-wise vaccination reports
