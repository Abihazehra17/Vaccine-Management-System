  ...
  <div class="d-flex align-items-center gap-3">
    ...
    <div class="dropdown">
      <button class="user-profile-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <span class="user-name-text d-none d-sm-inline">City Hospital Staff</span>
      </button>

      <!-- Dropdown Card (matching Image 1) -->
      <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-3" style="min-width: 250px;">
        <li class="d-flex align-items-center gap-3 mb-2 pb-2 border-bottom">
          ...
          <div>
            <div class="fw-bold text-dark" style="font-size: 0.9rem;">Dr. Sarah Khan</div>
            <small class="text-muted" style="font-size: 0.75rem;">hospital@vaxcare.gov</small>
            <div>
